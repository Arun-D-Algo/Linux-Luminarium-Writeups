...
### Solve
**Flag:** `pwn.college{c4z24KpKBKPD9q9SmCfHGOgDUDI.QX5ETN1wiNyUDN0EzW}`

Used the 'ln -s' command to soft link the not-the-flag file to /flag file, then ran /challenge/catflag to get the flag.

```bash
hacker@commands~linking-files:~$ ln -s /flag ~/not-the-flag
hacker@commands~linking-files:~$ /challenge/catflag
About to read out the /home/hacker/not-the-flag file!
pwn.college{c4z24KpKBKPD9q9SmCfHGOgDUDI.QX5ETN1wiNyUDN0EzW}
```

### New Learnings
Learnt about soft and hard links and how to use them.